                        ...
                        <div class="card text-white bg-flat-color-3">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                  ...
                                  <a href="viewStudent.php"><p class="text-light mt-1 m-0">Students</p></a>  
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-1">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                   ...
                                   <a href="viewCourses.php"><p class="text-light mt-1 m-0">Courses</p></a>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-secondary">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?= $totalStudentsMarks;?></span>
                                   
                                    </h3>
                                  <a href="viewScore.php">  <p class="text-light mt-1 m-0">Scores</p></a>
                                </div><!-- /.card-left -->
                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="currency float-left mr-1"></span>
                                        <span class="count"><?= $totalEployees;?></span>
                                     
                                    </h3>
                                   <a href="viewEmployee.php"><p class="text-light mt-1 m-0">Employees</p></a> 
                                </div><!-- /.card-left -->
