...
if (!isset($_SESSION['username'])) {
    ...
    if ($delete == 'success') {
        ...
        $statusMsg = "Failed to delete employee. Please try again.";
    }
}
?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['role']; ?></td>
                                                <td><?= $row['username']; ?></td>
                                                <td><a href="editEmployee.php?id=<?= $row['employee_ID']; ?>" title="Edit Employee"><i class="fa fa-edit fa-1x"></i></a>
                                                    <a onclick="return confirm('Are you sure you want to delete?')" href="deleteEmployee.php?id=<?= $row['employee_ID']; ?>" title="Delete Employee "><i class="fa fa-trash fa-1x"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
