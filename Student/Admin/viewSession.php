...
if ($delete == 'success') {
    ...
    $statusMsg = "Course Session deleted successfully.";
    header("refresh:2; url=viewSession.php");
} elseif ($delete == 'fail') {
    $alertStyle = "alert alert-danger";
    $statusMsg = "Failed to delete Course Session. Please try again.";
}
                            ...
                            <div  class="<?php echo $alertStyle;?>" role="alert"><?php echo $statusMsg;?></div>
                                ...
                                ?>
                                 <tr>
                                    ...
                                    <td><?= $row['end_date'];?></td>
                                    <td><a href="editSession.php?id=<?= $row['session_ID']; ?>" title="Edit Course Session"><i class="fa fa-edit fa-1x"></i></a>
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="deleteSession?id=<?= $row['session_ID']; ?>" title="Delete Course Session"><i class="fa fa-trash fa-1x"></i></a>
                                        </td>
                                </tr>
                                <?php
                                }
