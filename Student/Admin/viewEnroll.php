...
if ($delete == 'success') {
    ...
    $statusMsg = "Course Enrollment deleted successfully.";

    header("refresh:4; url=viewEnroll.php");
} elseif ($delete == 'fail') {
    $alertStyle = "alert alert-danger";
    $statusMsg = "Failed to delete Course Enrollment. Please try again.";
    header("refresh:4; url=viewEnroll.php");
} elseif ($delete == 'assigned') {
    $alertStyle = "alert alert-danger";
    $statusMsg = "The student is already have mark in this course.";
    header("refresh:4; url=viewEnroll.php");
}
