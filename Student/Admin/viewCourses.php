...
if ($delete == 'success') {
    ...
    $statusMsg = "Failed to delete Course . Please try again.";
}
elseif ($delete == 'assigned') {
    $alertStyle ="alert alert-danger";
    $statusMsg = "This course is already assigned to a session.";
}
                            ...
                            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td><a href="editCourses.php?id=<?= $row['course_ID']; ?>" title="Edit Course"><i class="fa fa-edit fa-1x"></i></a>
                                            <a onclick="return confirm('Are you sure you want to delete?')" href="deleteCourses.php" title="Delete Course"><i class="fa fa-trash fa-1x"></i></a>
                                        </td>
