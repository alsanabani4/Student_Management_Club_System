...
if (isset($_GET['id'])) {
    ...
    $query1 = "SELECT e.student_association_ID,e.student_ID, s.first_name, s.last_name,e.course_ID, c.course_name
...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        $query = mysqli_query($con, "INSERT INTO `marks`(`student_ID`, `course_ID`, `description`, `mark`) VALUES ('$student_ID','$course_ID','$descriptionn' ,'$mark')");
        ...
        if ($query) {
            ...
            $lastname = "";
            $course_name = "";
            header("refresh:4; url=createScore.php");
        } else {
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">
                                    <h2 align="center">Add New Score</h2>
                                </strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT e.student_association_ID,e.student_ID, s.first_name, s.last_name,e.course_ID, c.course_name
                                   from student_course_association e
                                   INNER JOIN students s ON s.student_ID = e.student_ID
                                   INNER JOIN courses c ON c.course_ID = e.course_ID");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="createScore.php?id=<?= $row['student_association_ID']; ?>" title="Score"><i class="fa fa-edit fa-1x"></i></a>
