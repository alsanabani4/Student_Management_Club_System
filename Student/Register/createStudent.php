...
if (!isset($_SESSION['username'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($errors)) {
            $query = mysqli_query($con, "INSERT INTO `students`(`first_name`, `last_name`, `birthdate`, `gender`, `phone`, `parentNumber`, `address`) VALUES ('$firstname','$lastname','$dob','$gender','$phone','$parentNo','$address')");
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class=" <?php echo $alertStyle; ?>"role="alert" ><?php echo $statusMsg; ?></div>
                                        <form method="Post" action="">
                                            ...
                                            <!-- Closing tag for the div with class row -->
                                    </div>
                                    <!-- Closing tag for the div with class row -->
